...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/DLBCLPredictionUpdated/inst/doc/UsingSkeletonPackage.pdf)
...
```r
  library(DLBCLPredictionUpdated)
  # USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./DLBCLPredictionUpdatedResults"
...
cohortTable <- 'DLBCLPredictionUpdatedCohort'
#=======================
...
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/DLBCLPredictionUpdated")
```
