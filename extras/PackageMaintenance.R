...
OhdsiRTools::checkUsagePackage("DLBCLPredictionUpdated")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/DLBCLPredictionUpdated.pdf")
shell("R CMD Rd2pdf ./ --output=extras/DLBCLPredictionUpdated.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "DLBCLPredictionUpdated")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("DLBCLPredictionUpdated")
